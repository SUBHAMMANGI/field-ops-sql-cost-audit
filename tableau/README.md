...
## About the Developer
This project is maintained by Subham Mangi, a Data Analyst with over 3 years of experience building SQL and Python pipelines and developing Tableau dashboards for business stakeholders. With a background in resolving data quality issues and delivering production-grade analytics, Subham focuses on creating efficient reporting systems using tools like dbt and PostgreSQL.

### Contact Information
- GitHub: github.com/SUBHAMMANGI
- LinkedIn: linkedin.com/in/subhammangi
